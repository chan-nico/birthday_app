...
$(function() {
    ...
    for (var i = year; i >= 1900 ; i--) {
        if (choice_year === i) {
            ...
            $('#year').append('<option valu="' + i + '">' + i + '</option>');
        }
    }
    ...
    for (var j = 1; j <= 12; j++) {
        if (choice_month === j) {
            $('#month').append('<option value="' + j + '" selected' + '>' + j + '</option>');
        } else {
            $('#month').append('<option valu="' + j + '">' + j + '</option>');
        }
    }
    ...
    for (var k = 1; k <= 31; k++) {
        if (choice_date === k) {
            $('#date').append('<option value="' + k + '" selected' + '>' + k + '</option>');
        } else {
            $('#date').append('<option valu="' + k + '">' + k + '</option>');
        }
    }
