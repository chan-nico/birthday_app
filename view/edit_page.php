...
<body>
    ...
    <section>
        ...
        <form method="post" action="edit.php" enctype="multipart/form-data">
            ...
            <div class="name_box">
                <p>名前（ 20文字以内 ）</p>
                <input type="text" name="name" placeholder="名前を入力" value="<?php echo $list_data['name']; ?>"> *
            </div>
            ...
            <div class="comment_box">
                <p>一言コメント（ 30文字以内 ）</p>
                <input type="text" name="comment" placeholder="コメントを入力" value="<?php echo $list_data['comment']; ?>">
            </div>
            <div class="button">
